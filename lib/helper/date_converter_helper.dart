...
class DateConverter {
  static DateTime _parseServerDateTime(String dateTime) {
    try {
  ...
  static String convertTimeDifferenceInMinutes(String createdAt) {
    final DateTime createdDate = _parseServerDateTime(createdAt);
    final DateTime now = DateTime.now();
  ...
  static String earningReportDateTime(String dateTime) {
    final parsed = DateFormat('dd MMM yyyy hh:mm a').parse(dateTime);
