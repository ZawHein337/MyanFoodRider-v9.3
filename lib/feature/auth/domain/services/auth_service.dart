...
class AuthService implements AuthServiceInterface {
  ...
  Future<bool> saveUserToken(Response response) async {
    ...
    return await authRepositoryInterface.saveUserToken(response.body['token'], topics);
  }
  ...
  Future<void> updateAndTopicSubscrive() async {
    await authRepositoryInterface.getDmTopic();
  }

  @override
  Future<List<ShiftModel>?> getShiftList() async {
    return await authRepositoryInterface.getShiftList();
  }

  @override
  Future<Response> enableBiometricLogin(String token, String deviceID) async {
    return await authRepositoryInterface.enableBiometricLogin(token, deviceID);
  }

  @override
  Future<Response> biometricLogin(String token, String deviceID) async {
    return await authRepositoryInterface.biometricLogin(token, deviceID);
  }

  @override
  Future<bool> saveBiometricUserToken(String biometricToken) async {
    return await authRepositoryInterface.saveBiometricUserToken(biometricToken);
  }

  @override
  String getBiometricUserToken() {
    return authRepositoryInterface.getBiometricUserToken();
  }

  @override
  Future<bool> savedDeviceID(String deviceID) async {
    return await authRepositoryInterface.deviceID(deviceID);
  }

  @override
  Future<bool> setBiometric(bool isActive) async {
    return await authRepositoryInterface.setBiometric(isActive);
  }
