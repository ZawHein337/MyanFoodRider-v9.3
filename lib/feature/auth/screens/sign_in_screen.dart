            ...
            child: SizedBox(
              ...
              child: GetBuilder<AuthController>(builder: (authController) {
                return Column(children: [
                  ...
                  if (_isBiometricSupport == true && authController.biometric)
                    CustomButtonWidget(
                      buttonText: 'biometric_login'.tr,
                      isLoading: authController.isBiometricLoading,
                      onPressed: () => Get.toNamed(RouteHelper.getBiometricLoginRoute()),
