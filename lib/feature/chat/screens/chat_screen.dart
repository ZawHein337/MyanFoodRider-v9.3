                      ...
                      productView: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return MessageBubbleWidget(
                            ...
                            senderImage: chatController.messageModel!.conversation!.receiver?.imageFullUrl??'',
                          );
                        },
                      ),
                    ),
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: Row(crossAxisAlignment: CrossAxisAlignment.end, children: [
                                ...
                                Expanded(
                                  child: TextField(
                                    ...
                                    onSubmitted: (String newText) {
                                      if(newText.trim().isNotEmpty && !chatController.isSendButtonActive) {
                                ...
                                InkWell(
                                  onTap: () async {
                                    chatController.pickImage(false);
                                  },
                                  child: Padding(
                                ...
                                MenuAnchor(
                                  ...
                                  menuChildren: List<MenuItemButton>.generate(2, (int index) => MenuItemButton(
                                    onPressed: () {
                                      if(index == 0) {
                                        chatController.pickFile(false);
                                      } else {
                                        chatController.pickVideoFile(false);
                                      }
                                    },
                                    child: Row(
                                      children: [
