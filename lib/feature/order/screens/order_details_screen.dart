...
import 'package:stackfood_multivendor_driver/feature/order/widgets/estimated_delivery_widget.dart';
              ...
              if(order != null && orderController.orderDetailsModel != null ) {
                ...
                for(OrderDetailsModel orderDetails in orderController.orderDetailsModel!) {
                  for(AddOn addOn in orderDetails.addOns!) {
                    if(orderDetails.bogoGroupId == null){
              ...
              return (orderController.orderDetailsModel != null && controllerOrderModel != null && order != null) ? Column(children: [
                ...
                Expanded(child: SingleChildScrollView(
                  child: Column(children: [
                    ...
                    && controllerOrderModel.orderStatus != 'refunded' && controllerOrderModel.orderStatus != 'refund_request_canceled') ? EstimatedDeliveryWidget(
                      order: controllerOrderModel, detailsEta: orderController.orderDetailsEta,
                    ...
                    DetailsCustomCard(
                      ...
                      child: Builder(builder: (context) {
                        ...
                        List<List<OrderDetailsModel>> groupedOrderDetails = [];
                        Map<String, int> bogoGroupIndex = {};
                        for(OrderDetailsModel orderDetails in orderController.orderDetailsModel!) {
                          if(orderDetails.bogoGroupId != null && orderDetails.bogoGroupId!.isNotEmpty) {
                            if(bogoGroupIndex.containsKey(orderDetails.bogoGroupId)) {
                              groupedOrderDetails[bogoGroupIndex[orderDetails.bogoGroupId]!].add(orderDetails);
                            } else {
                              bogoGroupIndex[orderDetails.bogoGroupId!] = groupedOrderDetails.length;
                              groupedOrderDetails.add([orderDetails]);
                            }
                          } else {
                            groupedOrderDetails.add([orderDetails]);
                          }
                        ...
                        return Column(children: [
                          ...
                          Row(children: [
                            ...
                            Text(
                              '(${groupedOrderDetails.length.toString()})',
                          ...
                          ListView.builder(
                            ...
                            itemCount: groupedOrderDetails.length,
                            itemBuilder: (context, index) {
                              return OrderProductWidgetWidget(
                                order: controllerOrderModel,
                                orderDetails: groupedOrderDetails[index].first,
                                bogoGroup: groupedOrderDetails[index],
                                showDivider: index != groupedOrderDetails.length - 1,
                              );
                            },
                          ),
