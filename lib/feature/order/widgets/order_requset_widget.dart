...
import 'package:stackfood_multivendor_driver/helper/distance_converter_helper.dart';
...
class OrderRequestWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    double distance = Get.find<AddressController>().getRestaurantDistance(
      LatLng(double.tryParse(orderModel.restaurantLat ?? '0') ?? 0, double.tryParse(orderModel.restaurantLng ?? '0') ?? 0),
    );
            ...
            child: Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
              ...
              Expanded(
                ...
                child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Text(
                    'distance_away'.trParams({'distance': DistanceConverter.convertDistanceWithUnit(distance)}), maxLines: 1, overflow: TextOverflow.ellipsis,
                    style: robotoMedium.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color?.withValues(alpha: 0.7)),
                  ),
