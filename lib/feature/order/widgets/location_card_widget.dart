                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                    Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Row(children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            '${DistanceConverter.convertDistanceWithUnit(restaurantDistance)} ', maxLines: 1, overflow: TextOverflow.ellipsis,
                    ...
                    Row(children: [
                      ...
                      Container(
                        ...
                        padding: const EdgeInsets.all(Dimensions.paddingSizeExtraSmall),
                        child: Text(
                          DistanceConverter.convertDistanceWithUnit(restaurantToCustomerDistance), maxLines: 1, overflow: TextOverflow.ellipsis,
                          style: robotoBold.copyWith(fontSize: Dimensions.fontSizeSmall),
                        ),
                      ),
                    ]),
