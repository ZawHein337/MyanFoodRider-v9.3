...
class ProfileService implements ProfileServiceInterface {
  ...
  Future<ResponseModel?> checkPassword(String password) async{
    return await profileRepositoryInterface.checkPassword(password);
  }

  @override
  Future<ResponseModel?> disableBiometric() async{
    return await profileRepositoryInterface.disableBiometric();
  }

  @override
  Future<ResponseModel?> enableBiometric() async{
    return await profileRepositoryInterface.enableBiometric();
  }
