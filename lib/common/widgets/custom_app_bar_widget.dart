...
class CustomAppBarWidget extends StatelessWidget implements PreferredSizeWidget {
  ...
  const CustomAppBarWidget({super.key, required this.title, this.isBackButtonExist = true, this.onBackPressed, this.actionWidget, this.isCenterTitle = true});
  ...
  Widget build(BuildContext context) {
    return AppBar(
      ...
      leading: isBackButtonExist ? Padding(
        padding: EdgeInsets.only(left: isCenterTitle == false ? 10 : 0),
        child: IconButton(
      ...
      leadingWidth: isCenterTitle == false ? 30 : null,
